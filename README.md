...
> [!NOTE]   
> Por exemplo, a URL https://github.com/greg-balb/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`greg-balb`" para a contribuição no repositório `dio-lab-open-source`.
